    ...
    return (
      <div className='skills-entry'>
        ...
        <div className='skills-body'>
          ...
          <h5 className='skills-section-heading'>HTML/CSS Basics</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Responsive Design and Bootstrap</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>jQuery</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Basic Front End Development Projects</h5>
          <p>
            ...
            className='skills-link' target='blank'>new teeth</a> and partly in recognition of a life
          ...
          <h5 className='skills-section-heading'>Basic Javascript</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Object-Oriented and Functional Programming'</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Basic Algorithm Scripting</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>JSON APIs and AJAX</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Intermediate Front-End Projects</h5>
          <p>
          ...
          <p>
            ...
            into an <a href='https://codepen.io/f1ux1uxday/full/PWabRN' className='skills-link'
            target='blank'>insult generator</a>), a <a href='http://gilganesh.com/ACE/weather.html'
            className='skills-link' target='blank'> local weather app</a>, a <a
            href='http://zenradsyndicate.com/wikisearch.html' className='skills-link' target='blank'>
            Wikipedia search interface</a>, and a <a href='http://gilganesh.com/ACE/twitch.html'
            className='skills-link' target='blank'> twitch.tv user list</a>. These were reasonable
          ...
          <h5 className='skills-section-heading'>Intermediate Algorithm Scripting</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Advanced Algorithm Scripting</h5>
          <p>
          ...
          <h5 className='skills-section-heading'>Advanced Front-End Projects</h5>
          <p>
            ...
            className='skills-link'>Tic Tac Torment</a> and <a href='http://simon-joe.herokuapp.com'
            className='skills-link' target='blank'>Simon Joe, Memory Cat</a> I made a
            colorful calculator using <a href='http://gilganesh.com/ACE/calc.html'
            className='skills-link' target='blank'>jQuery</a>. After that, I started
            experimenting with the React framework and concocted a little tool I call the <a
            href='http://hypno-timer.herokuapp.com' className='skills-link' target='blank'>
          ...
          <h5 className='skills-section-heading'>The Gestalt</h5>
          <p>
